import './style.css';
const PROFILE = {"day":"Day025","title":"Tradeoff Path Wizard","one_sentence":"段階質問で意思決定パスを確定するウィザード型ツール。（話題:GitHub Trending (A）","core_action":"navigate","family":"decision_wizard","mechanic":"branching_questionnaire","input_style":"step_choices","output_style":"path_summary","audience_promise":"clearer_decisions","publish_hook":"質問に答えるだけで判断パスが固まる","engine":"wizard_tree","interaction_archetype":"decision_tree_wizard","page_archetype":"stepper_wizard","output_shape":"decision_path","state_model":"step_index_and_answers","core_loop":"answer -> branch -> finalize","component_pack":"stepper+branch_map","scaffold_id":"wizard_stepper","single_shot_text_generator":false};
